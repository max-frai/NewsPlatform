...
async fn tag_logic(
    ...
    let meta_desc = if let Some(ref tag) = tag_kind {
        match tag {
            ...
            TagKind::Per => "HubLoid Топ персон ➤ Последние новости по топовым личностям",
            TagKind::Norp => {
            ...
            TagKind::Loc => "HubLoid Страны и регионы ➤ Последние новости по странам и регионам",
